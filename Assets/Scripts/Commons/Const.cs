public abstract class Const
{
    ...
    public const string Prefabs_Board = "Prefabs/Board";
    public const string Prefabs_Pen = "Prefabs/Pen";
    public const string Prefabs_Ball = "Prefabs/Ball";
    public const string Prefabs_Table = "Prefabs/Table";
    ...
    public const string Image_Images_Start = "Images/Start";
    public const string Image_Images_Redo = "Images/Redo";
    public const string Image_Images_SwitchOff = "Images/SwitchOff";
    public const string Image_Images_SwitchOn= "Images/SwitchOn";
